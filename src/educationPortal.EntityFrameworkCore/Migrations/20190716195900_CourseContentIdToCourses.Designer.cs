...
namespace educationPortal.Migrations
{
    ...
    [Migration("20190716195900_CourseContentIdToCourses")]
    partial class CourseContentIdToCourses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("educationPortal.Tickets.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("educationPortal.Courses.Course", b =>
                {
                    ...
                    b.HasOne("educationPortal.Courses.CourseContent", "CourseContent")
                        .WithMany()
            ...
            modelBuilder.Entity("educationPortal.Courses.FavoriteCourse", b =>
                {
                    ...
                    b.HasOne("educationPortal.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("educationPortal.Courses.GivenCourse", b =>
                {
                    ...
                    b.HasOne("educationPortal.Authorization.Users.User", "Educator")
                        .WithMany()
